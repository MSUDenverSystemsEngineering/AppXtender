...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'appxtender' -CheckDiskSpace -PersistPrompt
        ...
        $exitCode = Execute-MSI -Action "Install" -Path "$dirFiles\AppXtender.MSI" -Parameters '/QN REBOOT=reallysuppress' -WindowStyle "Hidden" -PassThru
